...
def plot_optimal_account_values(B, I, R, T):
  plt.figure(figsize=(10, 6))
  plt.stackplot(np.arange(65,65+T+1), 
                B, I, R, 
                labels=[r'$B_t^\star$', 
                        r'$I_t^\star$', 
                        r'$R_t^\star$'])
...
def plot_optimal_withdrawal_amounts(b,i,r, ages):
  plt.figure(figsize=(10, 6))
...
def plot_roth_conversion(roth_conversion, ages):
  plt.figure(figsize=(10, 6))
...
def plot_taxable_income(omega, beta, ages):
  plt.figure(figsize=(10, 6))
...
if __name__ == '__main__':
  pass
  # You can use plotting functions defined above as follows:
  # plot_kappa(kappa, ages)
  # plot_phi(beta, eta, K)
  # plot_optimal_account_values(B, I, R, T)
  # plot_optimal_withdrawal_amounts(b, i, r, ages)
  # plot_roth_conversion(roth_conversion, ages)
  # plot_taxable_income(omega, beta, ages)